    ...
    <div class="container">
        ...
        <div class="banner-video">
            <div class="video-wrap  autoplay_off">
                <video height="500" controls poster="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/home/video.png" class="video-play">
                    <source autostart="false" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/video/Hướng dẫn chọn và thanh toán.mp4" type="video/mp4">
                </video>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="mb-5 mb-lg-0 me-9 me-lg-5">
                    <img class="img-fluid radius-16 overflow-hidden of-cover" width="100%" height="320px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/san-pham/danh-muc-benh-hiem-ngheo.jpg" alt="Danh mục bệnh">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="lower-section">
            <div class="row gx-5 clearfix">
                ...
                <div class="payment-block col-lg-6 col-md-6 col-sm-12">
                    <div class="payment-box pe-md-5 pe-0">
                        <div class="payment-box__icon">
                            <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/logo/logo3.png" alt="Logo">
                        </div>
                    ...
                    <div class="payment-box pe-md-5 pe-0">
                        <div class="payment-box__icon">
                            <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/home.png" alt="Home">
                        </div>
                        <div class="payment-box__info">
                ...
                <div class="payment-block col-lg-6 col-md-6 col-sm-12">
                    <div class="payment-box pe-md-5 pe-0">
                        <div class="payment-box__icon">
                            <img class="img-fluid mb-2" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/zalopay.svg" alt="Zalo Pay">
                            <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/napas.jpg" alt="Napas">
                        </div>
                        <div class="payment-box__info">
                    ...
                    <div class="payment-box pe-md-5 pe-0">
                        <div class="payment-box__icon">
                            <img class="img-fluid mb-2" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/payoo_logo.png" alt="Payoo">
                        </div>
                        <div class="payment-box__info">
                ...
                <div class="payment-block offset-lg-2 offset-lg-2 col-lg-8 col-md-8 col-sm-12">
                    <div class="payment-box pe-md-5 pe-0 mb-5 ms-auto me-auto">
                        <div class="payment-box__icon">
                            <img class="img-fluid mb-2" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/banking.png" alt="Banking">
                        </div>
                        <div class="payment-box__info">
                    ...
                    <div class="payment-img-bank d-flex flex-wrap justify-content-between">
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/1_Agribank.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/2_VCB.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/3_BIDV.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/4_Vietinbank.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/5_Techcombank.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/ABBANK.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/ACB.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/BAC A BANK.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/Ban Viet Bank.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/Bao Viet.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/BIDC.jpg" alt=""></div>
                        <div class="img-bank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/CoopBank.jpg" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ci-quyen-loi-box">
            <div class="row gx-3 gx-lg-0">
                ...
                <div class="col-lg-6 col-md-12 d-none d-md-block">
                    <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/family3.jpg" alt="">
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 d-none d-lg-block ci-app-img">
                <img class="img-fluid b-lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/mobile.png" alt="App">
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                <div class="ci-app-left">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <div>
                            <img class="img-fluid me-3" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/qrcode.png" style="max-height: 120px;">
                        </div>
                        <div class="d-flex flex-column">
                            <a href="" class="btn-app mb-3">
                                <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/app-store.svg">
                            </a>
                            <a href="" class="btn-app">
                                <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/google-play.svg">
                            </a>
                        </div>
                    </div>
                </div>
