            ...
            <div class="row gx-lg-5 align-items-center ">
                <div class="col-md-7">
                    <div class="text-white">
                        ...
                        <a href="<?php echo esc_url(home_url('/oxanh/trang-chu/')); ?>" class="ci-btn  ci-btn-hover-dark ci-btn-main d-inline-block">
                            <i class="far fa-arrow-right me-3"></i>Về chúng tôi</a>
                    </div>
                </div>
                <div class="col-md-5 ">
                    <div class="ps-lg-5 img-sanpham">
                        <img class="img-fluid radius-16 overflow-hidden of-cover" width="100%" height="300px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/san-pham/san-pham.jpg" alt="Ô Xanh">
                    </div>
                </div>
            </div>
        </div>
...
<div class="ci-block pb-0 text-center" id="topic-3">
    <div class="container">
        ...
        <div class="fz-16 mb-3 mb-md-5 text">
            Với gói G1 này, mức tương trợ tối đa cho thành viên lên tới <span class="fw-medium main-color">200.000.000₫</span>.
        ...
        <div class="">
            ...
            <div id="topic-4" class="row gx-5">
                ...
                <div class="col-lg-5 text-center">
                    <img class="img-fluid radius-16" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/san-pham/luu-y.jpg" alt="Ô Xanh">
                </div>
            </div>
    ...
    <div class="container">
        <div class="position-relative">
            ...
            <div>
                <div class="row gx-5">
                    <div class="col-lg-5">
                        <img class="img-fluid radius-16 mb-4" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/san-pham/thoi-gian-cho.jpg" alt="Ô Xanh">
                    </div>
                    <div class="col-lg-7">
        ...
        <div class="position-relative">
            ...
            <div>
                <div class="row gx-5 mb-3 mb-md-5">
                    <div class="col-lg-5">
                        <img class="img-fluid radius-16 mb-4" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/san-pham/cham-dut-ke-hoach.jpg" alt="Ô Xanh">
                    </div>
                    <div class="col-lg-7">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="denghiquytac1" class="accordion-collapse collapse" data-bs-parent="#ci-denghiquytac">
                            <div class="accordion-body">
                                ...
                                <p class="ci-list mb-3 mt-4">
                                    <span class="fw-medium d-block">Bước 2: Nộp hồ sơ tương trợ <a href="<?php echo esc_url(home_url('/oxanh/trang-chu/')); ?>">(tại đây)</a>:</span>
