<div class="ci-breadcrumb" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/pages/giai-quyet-quyen-loi.jpg);">
    <div class="container">
            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="ci-claim-process__img px-5  d-none d-md-block">
                        <img width="360px" class=" img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/pages/dieu-can-biet.png" alt="HTV">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="ci-claim-process__item">
