...
<body>
    <div id="ci-content" class="ci-content">
        ...
        <div class="ci-breadcrumb" style="background-image: url(<?php echo HTTP_PATH; ?>/assets/img/giup-do.jpg);">
            <div class="container">
                <div class="ci-breadcrumb-inner">
                    <h1 class="ci-breadcrumb-title">Mạnh thường quân</h1>
                    <div class="ci-breadcrumb-desc">
                        Tin tức sự kiện liên quan đến các mạnh thường quân
                    </div>
                </div>
            </div>
        </div>
