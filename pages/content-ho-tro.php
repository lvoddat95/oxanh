<div class="ci-breadcrumb" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/contact.jpg);">
    <div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="mb-5 mb-lg-0">
                    <img class="img-fluid radius-16 overflow-hidden of-cover" width="100%" height="300px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/family.jpg" alt="HTV">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="ci-heading">
...
<div class="ci-block">
    <div class="container">
        <div class="row justify-content-between flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-5">
                <div class="mb-5 mb-lg-0">
                    <img class="img-fluid radius-16 overflow-hidden of-cover" width="100%" height="300px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/family3.jpg" alt="HTV">
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/js/stores.map.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/js/map.js"></script>
