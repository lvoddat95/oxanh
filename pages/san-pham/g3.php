                            ...
                            <div class="col-md-7">
                                <div class="text-white">
                                    <div class="ci-heading">
                                        <h2 class="ci-heading__main text-white">Kế hoạch tương trợ <span>G3</span></h2>
                                    </div>
                                    <div class="fz-16 text-sanpham mb-3 mb-md-5" style="text-align: justify;">
                                        Với tỷ lệ mắc Bệnh hiểm nghèo gia tăng mỗi năm <br>
                                        Oxanh xin giới thiệu <span class="fw-medium text-warning">Kế hoạch tương trợ G3</span> sẽ giúp bạn giảm bớt lo âu với những quyền lợi ưu việt, mang lại sự chuẩn bị tốt nhất trước những rủi ro bất ngờ.
                                    </div>
            ...
            <div class="ci-block pb-0 text-center" id="topic-3">
                <div class="container">
                    ...
                    <div class="fz-16 mb-3 mb-md-5 text">
                        Với gói G3 này, mức tương trợ tối đa cho thành viên lên tới <span class="fw-medium main-color">500.000.000₫</span>.
                    ...
                    <div class="">
                        ...
                        <div class="mb-5">
                            <a href="javascript:void(0);" onclick="fancybox_modal('#toi-dong-y');" class="ci-btn g03-bg-color ci-btn-hover-dark text-white" tabindex="0">
