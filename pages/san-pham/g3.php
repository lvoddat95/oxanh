...
<body>
    <div id="ci-content" class="ci-content">
        ...
        <div class="ftoc open">
            ...
            <nav class="toc">
                <ul>
                    <li><a href="#topic-1">Kế hoạch tương trợ G3</a> </li>
                    <li>
        ...
        <main>
            ...
            <div class="ci-block ci-sanpham sanpham-g03" id="topic-1">
                <div class="container">
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-md-7">
                            <div class="ci-heading">
                                <h2 class="ci-heading__main main-color">Kế hoạch tương trợ <span>G3</span></h2>
                            </div>
                            <div class="fz-16 text-sanpham p-md-0" style="text-align: justify;">
                                Với tỷ lệ mắc Bệnh hiểm nghèo gia tăng mỗi năm <br>
                                Oxanh xin giới thiệu <span class="fw-medium">Kế hoạch tương trợ G3</span> sẽ giúp bạn giảm bớt lo âu với những quyền lợi ưu việt, mang lại sự chuẩn bị tốt nhất trước những rủi ro bất ngờ.
                            </div>
                        </div>
                        <div class="col-md-5 ">
            ...
            <div class="ci-block text-center bg-color1" id="topic-3">
                <div class="container">
                    ...
                    <div class="fz-16 mb-3 text">
                        Với gói G3 này, mức tương trợ tối đa cho thành viên lên tới <span class="fw-medium main-color">500.000.000</span> đồng.
                    ...
                    <div class="">
                        ...
                        <div class="d-block mt-3">
                            <a href="javascript:void(0);" onclick="fancybox_modal('#so-ngay-le-g3');" class="ci-docs__link m-1">
                ...
                <div class="container">
                    <div class="position-relative">
                        ...
                        <div class="mb-3">
                            ...
                            Các bệnh hiểm nghèo được định nghĩa trong kế hoạch này đề cập đến các bệnh, trạng thái bệnh hoặc các hoạt động được quy định trong <a title="Xem danh mục" href="#topic-1">Các bệnh hiểm nghèo</a>.
