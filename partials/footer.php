            ...
            <div class="row gx-5">
                <div class="col-lg-3">
                    <a href="<?php echo HTTP_PATH; ?>" class="logo-bottom">
                        <img class="b-lazy" src="<?php echo SOURCE; ?>assets/img/logo/logo3.png">
                    </a>
                </div>
                <div class="col-lg-3">
...
<div class="support">
    <a href="mailto:contact@oxanh.vn" data-tooltip="tipsy" data-position="right" original-title="Email">
        <i class="fa-solid fa-envelope"></i>
    </a>
    <a href="tel:0978240990" data-tooltip="tipsy" data-position="right" original-title="Hotline">
        <i class="fa-solid fa-phone-flip"></i>
    </a>
    <a target="_blank" rel="nofollow noopener" href="https://m.me/mikotechagency" data-tooltip="tipsy" data-position="right" original-title="Messenger">
    ...
    <a target="_blank" rel="nofollow noopener" href="https://zalo.me/id" data-tooltip="tipsy" data-position="right" original-title="Zalo">
    ...
    <!-- <a href="" data-tooltip="tipsy" data-position="left" original-title="Chat ngay!">
